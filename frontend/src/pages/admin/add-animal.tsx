      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:gap-8">
          <div className="flex-1 space-y-4">
                  ...
                  <SingleValueSelector
                    ...
                    onValueChange={(numberLabel) => {
                      const cage = cagesInSelectedZone.find(
                        (item) => formatCageNumber(item.number) === numberLabel,
                      );
            ...
            {/* ZNALEZIONY (MIEJSCE) */}
            <div className="space-y-2">
              <Label htmlFor="foundLocation" required>
                Znaleziony w miejscowości
              </Label>
              <Input
                id="foundLocation"
            ...
            {/* ZNALEZIONY (DATA) */}
            <div className="space-y-2">
              <Label htmlFor="foundAt" required>
                Znaleziony w dniu
              </Label>
              <Input
                id="foundAt"
